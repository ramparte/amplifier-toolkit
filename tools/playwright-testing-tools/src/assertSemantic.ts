...
async function callVisionModel(
  screenshot: Buffer,
  prompt: string,
  options: Required<SemanticOptions>
 ...
 */
function parseVerdictResponse(text: string): { verdict: 'PASS' | 'FAIL'; reason: string } {
  // Extract verdict
 ...
 * ```
 */
export async function assertSemanticQuick(
  page: Page,
  assertion: Omit<SemanticAssertion, 'options'>
): Promise<SemanticResult> {
